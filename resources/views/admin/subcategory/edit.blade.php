        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{ route('admin.subcategory.update', ['id' => $category->id]) }}" method="post" id="edit-form" enctype="multipart/form-data">
                        @csrf
                        <!-- Card body -->
                        <div class="card-body">
                            <!-- Hidden input -->
                            ...
                            <div class="row row-sm">
                                <div class="col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $category->name }}" placeholder="Enter Book Name" data-check-url="{{route('admin.category.checkName')}}"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select-picker" id="parent_id" name="parent_id">
                            ...
                            <div class="row row-sm">
                                <div class="col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    if(isset($category->image) && !empty($category->image))
                                    {
                                        ...
                                        //$image = \Storage::disk("local")->url("images/category/".$image);
                                    }
                                    @endphp
                                    <div class="form-group">
                                        <label class="">Image 
                        ...
                        <div class="card-footer">
                            <div class="row row-sm">
                                <div class="col-md-12 col-lg-12 col-xl-12 text-right">
                                    <div class="form-group">
                                        <a href="{{route('admin.subcategory.index')}}" class="btn btn-info">Cancel</a>
...
<script src="{{ asset('public/js/subcategory/edit.js') }}"></script>
@endpush