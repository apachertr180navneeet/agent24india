            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('admin.subcategory.store') }}" method="post" id="add-form" enctype="multipart/form-data">
                            @csrf
                            <!-- Card body -->
                            <div class="card-body">
                                <div class="row row-sm">
                                    <div class="col-md-6 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="Enter Name" data-check-url="{{route('admin.subcategory.checkName')}}"/>
                                        </div>
                                    </div>
...
<script src="{{ asset('public/js/subcategory/create.js') }}"></script>
@endpush