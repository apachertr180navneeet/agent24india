            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            @if(auth()->user()->hasPermissionTo('Add Category'))
                                <a href="{{ route('admin.category.create') }}" class="btn btn-block btn-primary"><i class="fas fa-plus"></i> Add</a>
                            @endif
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="card-body" style="overflow: auto;">
                        <table id="dataTable" class="table table-bordered table-hover" data-url="{{route('admin.category.getCategories')}}" data-destroy-url="{{route('admin.category.destroy')}}" data-change-status-url="{{route('admin.category.changeStatus')}}" data-export-csv-url="{{route('admin.category.export', ['type' => 'excel'])}}">
                            <thead>
                                <tr>
                                    <th>S.no.</th>
                                    <th>Name</th>
...
<!-- /.content -->
@php
$viewPermission = auth()->user()->hasPermissionTo('View Category');
$editPermission = auth()->user()->hasPermissionTo('Edit Category');
$deletePermission = auth()->user()->hasPermissionTo('Delete Category');
@endphp
...
<script src="{{ asset('public/js/category/index.js') }}"></script>
@endpush
