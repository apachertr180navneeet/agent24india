...
<html lang="en">
    <head>
        ...
        @endphp
         ...
         <!-- JQVMap -->
         <link rel="stylesheet" href="{{ $assetUrl('plugins/jqvmap/jqvmap.min.css') }}" />
         <!-- Theme style -->
         <link rel="stylesheet" href="{{ $assetUrl('dist/css/adminlte.min.css') }}" />
         <!-- overlayScrollbars -->
         <link rel="stylesheet" href="{{ $assetUrl('plugins/overlayScrollbars/css/OverlayScrollbars.min.css') }}" />
         <!-- Daterange picker -->
         ...
         <link rel="stylesheet" href="{{ $assetUrl('plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css') }}" />
         <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11.7.32/dist/sweetalert2.min.css">
         <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" rel="stylesheet">
         <!-- Bootstrap Select CSS -->
        <link href="{{ $assetUrl('plugins/bootstrap-select/bootstrap-select.min.css') }}" rel="stylesheet"/>

        <link href="{{ $assetUrl('css/custom.css') }}" rel="stylesheet" type="text/css" />
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
        ...
        <script src="{{ $assetUrl('plugins/bootstrap-select/bootstrap-select.min.js') }}"></script>
        <!-- DataTables -->
        ...
        <script src="{{ $assetUrl('plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js') }}"></script>
        <!-- daterange picker -->
        ...
        <!-- AdminLTE App -->
        <script src="{{ $assetUrl('dist/js/adminlte.js') }}"></script>

        <!-- Jquery Form Validation Plugin -->
        <script src="{{ $assetUrl('plugins/jquery-validation/jquery.validate.min.js') }}"></script>
        <script src="{{ $assetUrl('plugins/jquery-validation/additional-methods.min.js') }}"></script>
        <script src="{{ $assetUrl('plugins/jquery-validation/jquery.validate.file.js') }}"></script>
