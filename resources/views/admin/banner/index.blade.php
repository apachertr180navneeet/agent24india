            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            @if(auth()->user()->hasPermissionTo('Add Banner'))
                                <a href="{{ route('admin.banner.create') }}" class="btn btn-block btn-primary"><i class="fas fa-plus"></i> Add</a>
                            @endif
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="card-body" style="overflow: auto;">
                        <table id="dataTable" class="table table-bordered table-hover" data-url="{{route('admin.banner.getBanners')}}" data-destroy-url="{{route('admin.banner.destroy')}}" data-change-status-url="{{route('admin.banner.changeStatus')}}" data-export-csv-url="{{route('admin.banner.export', ['type' => 'excel'])}}">
                            <thead>
                                <tr>
                                    <th>S.no.</th>
                                    <th>Name</th>
...
<!-- /.content -->
@php
$viewPermission = auth()->user()->hasPermissionTo('View Banner');
$editPermission = auth()->user()->hasPermissionTo('Edit Banner');
$deletePermission = auth()->user()->hasPermissionTo('Delete Banner');
@endphp
...
<script src="{{ asset('public/js/banners/banners.js') }}"></script>
@endpush
