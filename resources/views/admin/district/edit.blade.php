        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{ route('admin.district.update', ['id' => $district->id]) }}" method="post" id="edit-form" enctype="multipart/form-data">
                        @csrf
                        <!-- Card body -->
                        <div class="card-body">
                            <!-- Hidden input -->
                            ...
                            <div class="row row-sm">
                                <div class="col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" value="{{ $district->name }}" placeholder="Enter Name" data-check-url="{{route('admin.district.checkName')}}"/>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select-picker" id="state_id" name="state_id">
                                            ...
                                            @foreach($states as $key => $value)
                                                <option value="{{$value->id}}" {{($value->id == $district->state_id) ? 'selected' : ''}}>{{$value->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
...
<script src="{{ asset('public/js/district/edit.js') }}"></script>
@endpush