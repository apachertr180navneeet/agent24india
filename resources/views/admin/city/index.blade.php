            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            @if(auth()->user()->hasPermissionTo('Add City'))
                                <a href="{{ route('admin.city.create') }}" class="btn btn-block btn-primary"><i class="fas fa-plus"></i> Add</a>
                            @endif
                        </div>
                    </div>
                    </div>
...
<!-- /.content -->
@php
$viewPermission = auth()->user()->hasPermissionTo('View City');
$editPermission = auth()->user()->hasPermissionTo('Edit City');
$deletePermission = auth()->user()->hasPermissionTo('Delete City');
@endphp
