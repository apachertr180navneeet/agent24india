...
@section('content')
 <div class="container my-3">
            <div class="vendorhead">
                <p class="service">Popular Travel</p>
                <h2>{{ $vendoruser->name }}</h2>
                <p class="service">{{ $vendoruser->business_name }}</p>
                <p class="location"><i class="lni lni-map-marker"></i>{{ $vendoruser->address }}, {{ $vendoruser->city_name }}, {{ $vendoruser->district_name }} ,{{ $vendoruser->state_name }}</p>
            </div>
