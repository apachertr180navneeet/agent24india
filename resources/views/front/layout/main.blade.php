...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('public/front/assets/images/logo/favicon.png') }}" />
    ...
    <link rel="stylesheet" href="{{ asset('public/front/assets/css/responsive.css') }}?v=1.3" />
...
<body>
    ...
    @php
        $businessCategory = $siteCategories ?? collect();
