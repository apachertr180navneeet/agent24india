...
class City extends Model
{
    ...
    {
        $records = City::select('cities.id', 'cities.state_id', 'cities.district_id', 'cities.name', 'cities.status', 'cities.created_at', 'states.name as state_name', 'districts.name as district_name')
